                ...
                <div class="col-md-10 maincontent" >
                    ...
                    <div class="panel panel-default contentinside">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" action="c_update" method="">
                                <div class="form-group">
                                    <label  class="col-sm-2 control-label">Case Id:</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="caseid" value="${ds.c_id}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="p_id" value="${ds.p_id}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="date" value="${ds.date}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="time" value="${ds.time}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="charge" value="${ds.charge}">
                                    </div>
                                </div>
