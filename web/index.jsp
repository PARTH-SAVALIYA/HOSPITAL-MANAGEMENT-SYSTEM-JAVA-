                ...
                <div class="col-md-12">
                    <div class="panel panel-default login">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal center-block" role="form" action="session" method="post" >
                                ...
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text" name="password" class="form-control" placeholder="Password" required aria-describedby="sizing-addon1">
                                </div>
                                <br/>
